      ...
      <div className='flex pt-[120px] pb-[36px] min-[480px]:pb-[48px] min-[768px]:pt-[140px] min-[768px]:pb-[60px] min-[992px]:pt-[100px] min-[992px]:pb-[80px] bg-[#f4f8fa] text-[#07090c]'>
        <GridWrapper>
          <div className='grid row-[1/2] self-end col-[2/3] mx-auto max-w-[525px] justify-items-center justify-center grid-cols-[1fr] grid-rows-[auto] text-center gap-y-[36px] gap-x-[40px]'>
            ...
            >
              <input
                className='min-w-[65vw] min-[768px]:min-w-[350px]  min-h-[50px] pl-[24px] text-[16px] text-[#333] w-full h-[38px] align-middle bg-[rgba(255,255,255,0)] leading-1.5 p-[8px_12px] tracking-normal'
                maxLength={256}
                name='query'
                placeholder='Enter what your search...'
                type='search'
                id='search'
                required
                value='hello'
            ...
            <div className='grid pt-0 min-[768px]:pt-[24px] gap-x-[16px] gap-y-[40px] grid-rows-[auto] grid-cols-[1fr]'>
              <div>
                <div className='grid grid-cols-[1fr] min-[992px]:grid-cols-[1fr_1fr] grid-rows-[auto_auto] gap-x-[80px]'>
                  <div className='grid grid-cols-[1fr] gap-y-[24px] min-[768px]:gap-y-[16px] py-[36px] min-[768px]:grid-cols-[.8fr_1fr] border-b border-[#e4e9ec] p-[60px_0] transition-[background-color_.4s_cubic-bezier(.25,.46,.45,.94)] '>
                    <div
                      style={{
                        backgroundImage:
                          'url("https://d3e54v103j8qbb.cloudfront.net/img/generic/image14.jpg")',
                      }}
