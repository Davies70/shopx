...
export const FAQ = [
  {
    ...
    answer: 'We restock our spoof survival gear every month, depending on demand and supply chain shenanigans. If an item is out of stock, sign up for our newsletter to get notified as soon as it’s back. Our bunker elves work tirelessly to keep the shelves full. Stay prepared—restocks can happen at any moment!',
  },
  {
    question: 'Discount codes & promotions',
    answer: 'We offer exclusive discount codes during major apocalyptic events and random Tuesdays. Follow us on social media or subscribe to our emails for the latest deals. Promotions are limited, so act fast before the world ends. Remember, nothing says “prepared” like saving a few bucks!',
  },
  {
    question: 'Are your products actually survival tested?',
    answer: 'Our spoof survival gear is tested in the wildest environments—like living rooms and backyard barbecues. While they look the part, these products are designed for laughs and novelty, not real emergencies. Please don’t rely on them for actual survival situations. Enjoy the fun and share a smile with fellow preppers!',
  },
  {
    question: 'Can I return a product if the apocalypse happens?',
    answer: 'If the apocalypse happens, our return policy is simple: keep the gear and good luck! For all other scenarios, we offer a 30-day hassle-free return policy. Just contact our support team and we’ll help you out. Remember, refunds are not valid during zombie outbreaks.',
  },
  {
    question: 'Do you ship internationally?',
    answer: 'Yes, we ship our spoof survival gear worldwide, as long as the postal service is still running. Shipping times may vary depending on your bunker’s location. Customs may ask questions about tactical cat helmets—just smile and nod. Prepare for the end, no matter where you are!',
  },
  {
    question: 'Is your gear safe for pets?',
    answer: 'Our spoof gear is designed with fun in mind and is generally safe for pets under supervision. Always check the product description for any specific warnings. We recommend supervising your furry friends during use. Safety first, even in pretend doomsday scenarios!',
  },
  {
    question: 'How do I care for my DoomsDay Helmet?',
    answer: 'To keep your DoomsDay Helmet looking sharp, wipe it down with a damp cloth after each adventure. Avoid harsh chemicals or exposing it to actual combat situations. Store it in a cool, dry place away from curious cats. With proper care, your helmet will be ready for any costume party or apocalypse drill!',
  },
];
...
export const shippingAndReturnsFAQ = [
  {
    ...
    answer: 'Shipping typically takes 3-7 business days within the US and 7-21 business days for international orders. Delivery times may vary depending on your location and current world events.',
  },
  {
    question: 'What is your return policy?',
    answer: 'We offer a 30-day hassle-free return policy on all spoof survival gear. If you’re not satisfied, contact our support team and we’ll guide you through the return process.',
  },
  {
    question: 'Do you provide tracking for shipments?',
    answer: 'Yes, once your order ships, you’ll receive a tracking number via email so you can follow your package’s journey to your bunker.',
  },
];
...
export const camoAndGearFAQ = [
  {
    ...
    answer: 'Our camo and gear products are designed in-house and manufactured by trusted partners in the US and overseas. We ensure each item meets our standards for novelty, comfort, and feline fashion.',
  },
  {
    question: 'What materials are used in your armor and gear?',
    answer: 'Our spoof armor and gear are made from lightweight, pet-friendly materials such as polyester, cotton blends, and soft foam padding. They are designed for costume use and comfort, not for real protection.',
  },
  {
    question: 'What sizes are available for your camo and gear?',
    answer: 'We offer a range of sizes to fit most cats and small pets. Please refer to our size chart on each product page for measurements and tips on choosing the right fit for your furry friend.',
  },
];